...
<br/>
<form name="newMsgForm" id="newMsgForm" method="post" action="{{ url("Messages/update") }}">
    <div class="form-group">
        ...
        <textarea class="form-control" type="text" id="message" placeholder="Entrez un message"
                  name="content"></textarea>
    </div>
</form>
<div class="btn btn-primary" id="submitMsg">Envoyer</div>
